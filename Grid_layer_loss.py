...
def main():
    ...
    epochs_list  = [50000]      # Tested number of epochs
    ...
    patience = 200  # snapshot every N epochs
            ...
            for r1 in r1_list:
                for r2 in r2_list:
                    for lambda_l2 in lambda_l2_list:
                        ...
                        # ------------------------- VISUALISATIONS -------------------------
                        plot_nmf_results(W1@W2, H_out, errorsGD_s, rankGD, nuclearrankGD, SVGD1, SVGD2, (3,28,28), X, epochs_metrics=epochs_metrics_s)
